                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.code == false) {
                            ...
                            _self.find('.rn-btn').after('<div class="error-msg bg-danger text-white rounded-3 mt-4 p-3"><p class="small text-white my-1">' + data.err + '</p></div>');
                        } else {
                            $('.error-msg').hide();
                            $('.form-group').removeClass('focused');
                            _self.find('.rn-btn').after('<div class="success-msg bg-success rounded-3 mt-4 p-3"><p class="small text-white my-1">' + data.success + '</p></div>');
